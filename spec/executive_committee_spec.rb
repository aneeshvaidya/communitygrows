...
RSpec.describe "Executive Committee Announcements/Document List", :type => :request do
  describe "CommunityGrows website" do
    ...
    it 'should make a new executive announcement and edit it' do
      visit '/executive_committee'
      ...
      page.should have_content("Executive Subcommittee")
    end
    
    it 'should make a new executive document list and edit it' do
      visit '/executive_committee'
